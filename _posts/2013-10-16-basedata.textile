...
I wrote a short script as a personal exercise in procedural R coding to generate the SQL for either Mysql or Postgresql from the R data() sets.  It is available below.
