...
Note this plugin is modified that when you double click on a symbol it will automically load vim with the tag as an argument.  Ensure that you generate a tags file with ctags and that you have an appropriate tags path in vimrc.
