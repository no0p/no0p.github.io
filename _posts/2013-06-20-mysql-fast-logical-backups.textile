...
bc. mydumper --database mydb --user username --password PASSWORD --outputdir /backup/mydump --compress --compress-protocol --threads=2 -m
...
myloader --database mydb -o --threads 4 --compress-protocol -u usern -p PASSWORD -d backup/mydump
